/* ══════════════════════════════════════════════════════════════════════════
   MUSCU RPG — body/body3d_v60.js
   ENGINE v5.7 — Arm Refinement Edition (ES5 Stable)
   ══════════════════════════════════════════════════════════════════════════ */
...
var BODY3D = {
  ...
  buildAthleticBody: function() {
    ...
    // BRAS - Réduction de 5% (v60)
    // Rayon 0.1216 / 0.1064 (Ancien 0.128 / 0.112)
    ...
    // AVANT-BRAS (Taille conservée 0.09)
