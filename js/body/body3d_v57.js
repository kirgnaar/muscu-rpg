/* ══════════════════════════════════════════════════════════════════════════
   MUSCU RPG — body/body3d_v57.js
   ENGINE v5.4 — Precise Size Adjustment (ES5 Stable)
   ══════════════════════════════════════════════════════════════════════════ */
...
var BODY3D = {
  ...
  buildAthleticBody: function() {
    ...
    // 1. LE BRAS (Haut) - RESTAURATION POSITION + TAILLE 0.09
    // rz négatif pour le bras gauche = ÉLOIGNEMENT du buste (45°)
    addPart(cylGeo(0.09, 0.08, 0.36), -0.44, 1.6, 0, 0, -0.785, 'bras_l', true);
    addPart(cylGeo(0.09, 0.08, 0.36), 0.44, 1.6, 0, 0, 0.785, 'bras_r', true);

    // 2. L'AVANT-BRAS (Bas) - RESTAURATION POSITION + TAILLE 0.07
    // rz positif pour le bras gauche = RAPPROCHEMENT du buste (45°)
