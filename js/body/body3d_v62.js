/* ══════════════════════════════════════════════════════════════════════════
   MUSCU RPG — body/body3d_v62.js
   ENGINE v5.9 — Enhanced Glutes Edition (ES5 Stable)
   ══════════════════════════════════════════════════════════════════════════ */
...
var BODY3D = {
  ...
  buildAthleticBody: function() {
    ...
    var addPart = function(geo, x, y, z, rx, rz, name, pivotAtTop) {
      if (pivotAtTop && geo.parameters && geo.parameters.height) {
    ...
    // FESSIERS - Élargis (v62)
    // Rayon augmenté de 0.14 à 0.19 (+35%)
    var gluteGeo = new THREE.SphereGeometry(0.19, 24, 24, Math.PI, Math.PI);
    addPart(gluteGeo, -0.16, 0.85, -0.10, 0, 0, 'glutes_l');
    addPart(gluteGeo, 0.16, 0.85, -0.10, 0, 0, 'glutes_r');
