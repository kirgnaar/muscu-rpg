...
var BODY3D = {
  ...
  buildAthleticBody: function() {
    ...
    // BRAS (Biceps/Triceps) - Alignement GÉOMÉTRIQUE RECTIFIÉ (v32)
    // Pivot ajusté pour connecter l'épaule (0.32) au coude (0.48)
    addPart(cylGeo(0.07, 0.06, 0.36), 1.45, -0.47, 0.08, 0.45, 0.55, 'biceps_l');
    addPart(cylGeo(0.07, 0.06, 0.36), 1.45, 0.47, 0.08, 0.45, -0.55, 'biceps_r');
