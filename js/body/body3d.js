...
var BODY3D = {
  ...
  buildAthleticBody: function() {
    ...
    // 1. LE BRAS (Haut) - Réduction supplémentaire (v55)
    // Rayon 0.11 (v54: 0.128)
    addPart(cylGeo(0.11, 0.095, 0.36), -0.45, 1.6, 0, 0, -0.785, 'bras_l', true);
    addPart(cylGeo(0.11, 0.095, 0.36), 0.45, 1.6, 0, 0, 0.785, 'bras_r', true);

    // 2. L'AVANT-BRAS (Bas) - Réduction supplémentaire (v55)
    // Rayon 0.08 (v54: 0.09)
    addPart(cylGeo(0.08, 0.065, 0.4), -0.704, 1.346, 0, 0, 0.785, 'avantbras_l', true);
    addPart(cylGeo(0.08, 0.065, 0.4), 0.704, 1.346, 0, 0, -0.785, 'avantbras_r', true);
