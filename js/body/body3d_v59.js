/* ══════════════════════════════════════════════════════════════════════════
   MUSCU RPG — body/body3d_v59.js
   ENGINE v5.6 — Half-Cylinder Split Edition (ES5 Stable)
   ══════════════════════════════════════════════════════════════════════════ */
...
var BODY3D = {
  ...
  buildAthleticBody: function() {
    ...
    // BRAS - VRAI SPLIT GÉOMÉTRIQUE (DEMI-CYLINDRES)
    // Taille restaurée (0.128 / 0.112)
    // Gauche
    addPart(halfCyl(0.128, 0.112, 0.36, 0), -0.44, 1.6, 0, 0, -0.785, 'biceps_l', true);
    addPart(halfCyl(0.128, 0.112, 0.36, 1), -0.44, 1.6, 0, 0, -0.785, 'triceps_l', true);
    // Droite
    addPart(halfCyl(0.128, 0.112, 0.36, 0), 0.44, 1.6, 0, 0, 0.785, 'biceps_r', true);
    addPart(halfCyl(0.128, 0.112, 0.36, 1), 0.44, 1.6, 0, 0, 0.785, 'triceps_r', true);

    // AVANT-BRAS (Taille 0.09)
    ...
    // JAMBES - VRAI SPLIT GÉOMÉTRIQUE (DEMI-CYLINDRES)
    // Taille 0.16 / 0.12
    // Gauche
